...
glm::dvec3 planet::TerrainChunk::ChunkCenterPosition(const glm::dvec3 &planet_position, const double radius,
...
planet::TerrainChunk::TerrainChunk(const std::shared_ptr<PlanetTerrain> &planet_terrain,
...
void planet::TerrainChunk::GenerateTerrain(std::mutex &mutex, std::shared_ptr<TerrainChunk> &target_chunk) const {
