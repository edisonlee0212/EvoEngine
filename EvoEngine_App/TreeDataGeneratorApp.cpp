...
int main() {
  ...
  application_info.application_name = "Tree Data Generator";
  application_info.project_path = FindResourceFolder() / "EcoSysLabProject" / "test.eveproj";
  ...
  EVOENGINE_LOG(
      "TreeDataGeneratorApp now bootstraps DatasetGeneration as a runtime package. Direct generation commands "
      "need a package API before they can run from this app.")
