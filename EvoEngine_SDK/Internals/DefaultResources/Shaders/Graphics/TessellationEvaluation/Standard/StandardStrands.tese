...
layout(location = 7) patch in uint currentInstanceIndexIn;
...
void main(){
	...
	EE_SPLINE_INTERPOLATION(tcs_in[0].Color, tcs_in[1].Color, tcs_in[2].Color, tcs_in[3].Color, color, tempV4, gl_TessCoord.x);
