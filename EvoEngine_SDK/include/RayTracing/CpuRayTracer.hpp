...
class CpuRayTracer final {
 ...
 private:
  ...
  struct NodeInstance {
    ...
    void Initialize(const std::shared_ptr<RenderInstanceStorage>& render_instances, const std::shared_ptr<RenderInstanceStorage::MeshRenderInstance>& render_instance,
