...
EVOENGINE_API std::vector<SdfgiImageRequirement> GetSdfgiImageRequirements(
    uint32_t cascade_count = 4, uint32_t history_size = 30, uint32_t voxel_count_x = 128, uint32_t voxel_count_y = 64,
    uint32_t probe_spacing_cells = 4, uint32_t max_image_dimension = 16384);
...
EVOENGINE_API SdfgiCapabilityReport QuerySdfgiCapabilities(uint32_t cascade_count = 4, uint32_t history_size = 30,
                                                           uint32_t voxel_count_x = 128, uint32_t voxel_count_y = 64,
