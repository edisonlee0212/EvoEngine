...
void DrawLink(ImNodesEditorContext& editor, const int link_idx) {
  ...
  GImNodes->CanvasDrawList->AddBezierCubic(
#endif
      cubic_bezier.P0, cubic_bezier.P1, cubic_bezier.P2, cubic_bezier.P3, link_color, GImNodes->Style.LinkThickness,
...
static void MiniMapDrawNode(ImNodesEditorContext& editor, const int node_idx) {
  ...
  GImNodes->CanvasDrawList->AddRect(node_rect.Min, node_rect.Max, mini_map_node_outline, mini_map_node_rounding);
}
