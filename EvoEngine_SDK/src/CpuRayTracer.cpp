...
struct AggregateSceneInternal {
   ...
   */
  std::vector<CpuRayTracer::BvhNode> scene_level_bvh_nodes;
   ...
   */
  std::vector<CpuRayTracer::BvhNode> node_level_bvh_nodes;
   ...
   */
  std::vector<CpuRayTracer::BvhNode> mesh_level_bvh_nodes;
...
Entity CpuRayTracer::GetEntity(const uint32_t node_index) const {
