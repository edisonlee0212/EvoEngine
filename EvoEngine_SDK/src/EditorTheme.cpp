...
void editor_theme::ApplyEvoEngineLight() {
  ...
  colors[ImGuiCol_TextDisabled] = ImVec4(0.47f, 0.49f, 0.51f, 1.00f);
  colors[ImGuiCol_WindowBg] = ImVec4(0.94f, 0.95f, 0.95f, 1.00f);
  colors[ImGuiCol_ChildBg] = ImVec4(0.98f, 0.98f, 0.97f, 1.00f);
  colors[ImGuiCol_PopupBg] = ImVec4(1.00f, 1.00f, 0.98f, 0.98f);
  colors[ImGuiCol_Border] = ImVec4(0.76f, 0.78f, 0.80f, 1.00f);
  colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
  colors[ImGuiCol_FrameBg] = ImVec4(0.89f, 0.90f, 0.91f, 1.00f);
  colors[ImGuiCol_FrameBgHovered] = ImVec4(0.82f, 0.86f, 0.90f, 1.00f);
  colors[ImGuiCol_FrameBgActive] = ImVec4(0.76f, 0.82f, 0.87f, 1.00f);
  colors[ImGuiCol_TitleBg] = ImVec4(0.90f, 0.91f, 0.92f, 1.00f);
  colors[ImGuiCol_TitleBgActive] = ImVec4(0.84f, 0.86f, 0.88f, 1.00f);
  colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.90f, 0.91f, 0.92f, 0.86f);
  colors[ImGuiCol_MenuBarBg] = ImVec4(0.88f, 0.89f, 0.90f, 1.00f);
  colors[ImGuiCol_ScrollbarBg] = ImVec4(0.91f, 0.92f, 0.93f, 0.90f);
  colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.66f, 0.68f, 0.70f, 1.00f);
  colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.55f, 0.58f, 0.60f, 1.00f);
  colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.43f, 0.46f, 0.48f, 1.00f);
  ...
  colors[ImGuiCol_Button] = ImVec4(0.86f, 0.88f, 0.90f, 1.00f);
  colors[ImGuiCol_ButtonHovered] = ImVec4(0.78f, 0.83f, 0.87f, 1.00f);
  colors[ImGuiCol_ButtonActive] = ImVec4(0.94f, 0.78f, 0.52f, 1.00f);
  colors[ImGuiCol_Header] = ImVec4(0.84f, 0.88f, 0.92f, 1.00f);
  colors[ImGuiCol_HeaderHovered] = ImVec4(0.76f, 0.82f, 0.88f, 1.00f);
  colors[ImGuiCol_HeaderActive] = ImVec4(0.92f, 0.78f, 0.56f, 1.00f);
  colors[ImGuiCol_Separator] = ImVec4(0.74f, 0.76f, 0.78f, 1.00f);
  ...
  colors[ImGuiCol_Tab] = ImVec4(0.88f, 0.89f, 0.90f, 1.00f);
  colors[ImGuiCol_TabHovered] = ImVec4(0.78f, 0.83f, 0.87f, 1.00f);
  colors[ImGuiCol_TabSelected] = ImVec4(0.98f, 0.98f, 0.97f, 1.00f);
  colors[ImGuiCol_TabSelectedOverline] = ImVec4(0.70f, 0.40f, 0.08f, 1.00f);
  colors[ImGuiCol_TabDimmed] = ImVec4(0.88f, 0.89f, 0.90f, 1.00f);
  colors[ImGuiCol_TabDimmedSelected] = ImVec4(0.93f, 0.94f, 0.94f, 1.00f);
  ...
  colors[ImGuiCol_DockingEmptyBg] = ImVec4(0.92f, 0.93f, 0.94f, 1.00f);
  ...
  colors[ImGuiCol_TableHeaderBg] = ImVec4(0.84f, 0.86f, 0.88f, 1.00f);
  colors[ImGuiCol_TableBorderStrong] = ImVec4(0.70f, 0.72f, 0.74f, 1.00f);
  colors[ImGuiCol_TableBorderLight] = ImVec4(0.80f, 0.82f, 0.84f, 1.00f);
  colors[ImGuiCol_TableRowBg] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
