...
bool GlobalTransform::Decompose(glm::vec3& translation, glm::vec3& euler_angles, glm::vec3& scale) const {
  using namespace glm;
  using T = float;
...
bool GlobalTransform::Decompose(glm::vec3& translation, glm::quat& rotation, glm::vec3& scale) const {
  using namespace glm;
  using T = float;
  mat4 local_matrix(value);
...
glm::vec3 GlobalTransform::GetPosition() const {
  return value[3];
}
glm::vec3 GlobalTransform::GetScale() const {
  glm::vec3 scale;
  glm::vec3 trans;
  glm::quat rotation;
...
glm::quat GlobalTransform::GetRotation() const {
  glm::vec3 scale;
  glm::vec3 trans;
  glm::quat rotation;
  Decompose(trans, rotation, scale);
...
glm::vec3 GlobalTransform::GetEulerRotation() const {
  glm::vec3 scale;
  glm::vec3 trans;
  glm::vec3 rotation;
  Decompose(trans, rotation, scale);
...
void GlobalTransform::SetPosition(const glm::vec3& new_position) {
  this->value[3].x = new_position.x;
  this->value[3].y = new_position.y;
  this->value[3].z = new_position.z;
}
void GlobalTransform::SetScale(const glm::vec3& new_scale) {
  glm::vec3 scale;
  glm::vec3 trans;
  glm::quat rotation;
  Decompose(trans, rotation, scale);
...
void GlobalTransform::SetRotation(const glm::quat& new_rotation) {
  glm::vec3 scale;
  glm::vec3 trans;
  glm::quat rotation;
  Decompose(trans, rotation, scale);
...
void GlobalTransform::SetEulerRotation(const glm::vec3& new_euler_rotation) {
  glm::vec3 scale;
  glm::vec3 trans;
  glm::quat rotation;
  Decompose(trans, rotation, scale);
...
void GlobalTransform::SetValue(const glm::vec3& position, const glm::vec3& euler_rotation, const glm::vec3& scale) {
  value = glm::translate(position) * glm::mat4_cast(glm::quat(euler_rotation)) * glm::scale(scale);
}
void GlobalTransform::SetValue(const glm::vec3& position, const glm::quat& rotation, const glm::vec3& scale) {
  value = glm::translate(position) * glm::mat4_cast(rotation) * glm::scale(scale);
}
glm::vec3 GlobalTransform::TransformPoint(const glm::vec3& point) const {
  return value * glm::vec4(point, 1.f);
}
glm::vec3 GlobalTransform::TransformVector(const glm::vec3& vector) const {
  return value * glm::vec4(vector, 0.f);
}

bool Transform::Decompose(glm::vec3& translation, glm::vec3& euler_angles, glm::vec3& scale) const {
  using namespace glm;
  using T = float;
  mat4 local_matrix(value);
...
bool Transform::Decompose(glm::vec3& translation, glm::quat& rotation, glm::vec3& scale) const {
  using namespace glm;
  using T = float;
  mat4 local_matrix(value);
...
void Transform::SetEulerRotation(const glm::vec3& new_euler_rotation) {
  glm::vec3 scale;
  glm::vec3 trans;
  glm::quat rotation;
  Decompose(trans, rotation, scale);
...
void Transform::SetValue(const glm::vec3& position, const glm::vec3& euler_rotation, const glm::vec3& scale) {
  value = glm::translate(position) * glm::mat4_cast(glm::quat(euler_rotation)) * glm::scale(scale);
}
void Transform::SetValue(const glm::vec3& position, const glm::quat& rotation, const glm::vec3& scale) {
  value = glm::translate(position) * glm::mat4_cast(rotation) * glm::scale(scale);
}
