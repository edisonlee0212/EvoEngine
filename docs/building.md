...
This sorghum 261 branch stores the 261 resource bundle in the `Resources/DigitalAgricultureProject` submodule, backed by `Penanito/EvoEngine_SorghumProject`. Install Git LFS before cloning when possible, then pull submodule LFS assets:
