...
- Audit fixed-point8-bit ray traversal for zero/near-zero components before reciprocal conversion. Preserve reference hit semantics while preventing undefined integer conversion. Validate against an independent voxel-DDA oracle.
