...
Status: implementation in progress. H0-H4 implement voxel hierarchy, local updates, cached tracing and probe transport. Selecting HDDAGI still uses Environment for camera lighting; deferred gather/composition and reflection captures are H5 work. Transport diagnostics are available through Python.
