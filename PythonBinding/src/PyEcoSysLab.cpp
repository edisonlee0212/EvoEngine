...
void PyEcoSysLab::Initialize(pybind11::module& m) {
  ...
  py::enum_<CameraSettings::RayDebugView>(m, "RayDebugView")
      .value("Beauty", CameraSettings::RayDebugView::Beauty)
      .value("MaterialId", CameraSettings::RayDebugView::MaterialId)
      .value("BaseColor", CameraSettings::RayDebugView::BaseColor)
      .value("GeometricNormal", CameraSettings::RayDebugView::GeometricNormal)
      .value("ShadingNormal", CameraSettings::RayDebugView::ShadingNormal)
      .value("Roughness", CameraSettings::RayDebugView::Roughness)
      .value("Metallic", CameraSettings::RayDebugView::Metallic)
      .value("SpecularF0", CameraSettings::RayDebugView::SpecularF0)
      .value("AlphaCoverage", CameraSettings::RayDebugView::AlphaCoverage)
      .value("Transmission", CameraSettings::RayDebugView::Transmission)
      .value("Iridescence", CameraSettings::RayDebugView::Iridescence)
      .value("Emission", CameraSettings::RayDebugView::Emission)
      .value("DirectPunctual", CameraSettings::RayDebugView::DirectPunctual)
      .value("DirectEnvironment", CameraSettings::RayDebugView::DirectEnvironment)
      .value("DirectEmissive", CameraSettings::RayDebugView::DirectEmissive)
      .value("IndirectRadiance", CameraSettings::RayDebugView::IndirectRadiance)
  ...
  py::class_<CameraSettings>(m, "CameraSettings")
      ...
      .def_readwrite("ray_debug_view", &CameraSettings::ray_debug_view)
