...
extern "C" __global__ void __raygen__PCS() {
  ...
  auto &samples = pointCloudScanningLaunchParams.samples[ix];
  ...
  optixTrace(pointCloudScanningLaunchParams.traversable, rayOrigin, rayDirection,
             1e-3f,  // tmin
             1e20f,  // tmax
             0.0f,   // rayTime
