...
void BtfMaterial::UploadDeviceData() {
  btf_base.shared_coordinates.beta_angles_buffer.Upload(shared_coordinates_beta_angles);
  btf_base.shared_coordinates.beta_angles_device_ptr =
      reinterpret_cast<float *>(btf_base.shared_coordinates.beta_angles_buffer.DevicePointer());

  auto &pdf6 = btf_base.pdf6d;
  pdf6.pdf6d_buffer.Upload(pdf6d);
  pdf6.pdf6d_scale_buffer.Upload(pdf6d_scales);
  pdf6.pdf6d_device_ptr = reinterpret_cast<int *>(pdf6.pdf6d_buffer.DevicePointer());
  pdf6.pdf6d_scale_device_ptr = reinterpret_cast<float *>(pdf6.pdf6d_scale_buffer.DevicePointer());

  auto &pdf4 = pdf6.pdf4d;
  pdf4.pdf4d_scale_buffer.Upload(pdf4d_scales);
  pdf4.pdf4d_buffer.Upload(pdf4d);
  pdf4.pdf4d_scale_device_ptr = reinterpret_cast<float *>(pdf4.pdf4d_scale_buffer.DevicePointer());
  pdf4.pdf4d_device_ptr = reinterpret_cast<int *>(pdf4.pdf4d_buffer.DevicePointer());

  auto &pdf3 = pdf4.pdf3d;
  pdf3.pdf3d_scale_buffer.Upload(pdf3d_scales);
  pdf3.pdf3d_buffer.Upload(pdf3d);
  pdf3.pdf3d_scale_device_ptr = reinterpret_cast<float *>(pdf3.pdf3d_scale_buffer.DevicePointer());
  pdf3.pdf3d_device_ptr = reinterpret_cast<int *>(pdf3.pdf3d_buffer.DevicePointer());

  auto &pdf2 = pdf3.pdf2d;
  pdf2.luminance_color_index_buffer.Upload(luminance_color_indices);
  pdf2.luminance_color_indices_device_ptr = reinterpret_cast<int *>(pdf2.luminance_color_index_buffer.DevicePointer());

  auto &color = pdf2.color;
  color.pdf2d_buffer.Upload(pdf2d_colors);
  color.pdf2d_device_ptr = reinterpret_cast<int *>(color.pdf2d_buffer.DevicePointer());

  auto &luminance = pdf2.luminance;
  luminance.pdf1d_buffer.Upload(pdf2d);
  luminance.pdf1d_scale_buffer.Upload(pdf2d_scales);
  luminance.pdf1d_device_ptr = reinterpret_cast<int *>(luminance.pdf1d_buffer.DevicePointer());
  luminance.pdf1d_scale_device_ptr = reinterpret_cast<float *>(luminance.pdf1d_scale_buffer.DevicePointer());

  auto &iab = pdf2.index_ab;
  iab.indices_buffer.Upload(index_ab);
  iab.indices_device_ptr = reinterpret_cast<int *>(iab.indices_buffer.DevicePointer());

  auto &pdf1 = pdf2.pdf1d;
  pdf1.pdf1d_buffer.Upload(pdf1d);
  pdf1.pdf1d_device_ptr = reinterpret_cast<float *>(pdf1.pdf1d_buffer.DevicePointer());

  auto &ab = iab.vector_color;
  ab.colors_buffer.Upload(vector_color);
  ab.colors_device_ptr = reinterpret_cast<float *>(ab.colors_buffer.DevicePointer());
