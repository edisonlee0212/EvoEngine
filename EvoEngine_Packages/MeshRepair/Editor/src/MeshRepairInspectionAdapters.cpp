...
bool mesh_repair_package::InspectMeshColoring(InspectorContext& context, MeshColoring& mesh_coloring,
  ...
  auto& visibility_test_prefab_ref = state.visibility_test_prefab_ref;
  auto& visibility_test_mesh_ref = state.visibility_test_mesh_ref;
  ...
  auto& triangle_errors = state.triangle_errors;
  ...
  auto& triangle_error_prefab_ref = state.triangle_error_prefab_ref;
  editor_layer->DragAndDropButton<Prefab>(triangle_error_prefab_ref, "Triangle error Prefab");
  auto& error_threshold = state.error_threshold;
  ...
  auto& mesh_entity_ref = state.mesh_entity_ref;
