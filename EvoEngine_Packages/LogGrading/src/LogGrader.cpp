...
bool LogGrader::OnInspect(const std::shared_ptr<EditorLayer>& editor_layer) {
  ...
  if (debug_visualization) {
    ...
    // gizmoSettings);
    if (m_surface1)
      editor_layer->DrawGizmoMeshInstancedColored(Resources::GetInstance().GetPrimitives().quad, m_surface1,
    ...
    // gizmoSettings);
    if (m_surface2)
      editor_layer->DrawGizmoMeshInstancedColored(Resources::GetInstance().GetPrimitives().quad, m_surface2,
    ...
    // gizmoSettings);
    if (m_surface3)
      editor_layer->DrawGizmoMeshInstancedColored(Resources::GetInstance().GetPrimitives().quad, m_surface3,
                                                  transform.value, 1.f, gizmo_settings);
    ...
    // gizmoSettings);
    if (m_surface4)
      editor_layer->DrawGizmoMeshInstancedColored(Resources::GetInstance().GetPrimitives().quad, m_surface4,
                                                  transform.value, 1.f, gizmo_settings);
  }
