 ...
 * @brief Represents a segment of the Sorghum spline.
 *
 * This class stores the position, orientation, and radius of a segment of the Sorghum plant.
 */
class SorghumSplineSegment {
 public:
  ...
  /**
   * @brief Parameterized constructor to initialize a Sorghum spline segment.
...
/**
 * @class SorghumSpline
 * @brief Represents a spline composed of Sorghum segments.
 *
 * This class contains multiple SorghumSplineSegment instances and provides methods
 * for their procedural generation and processing.
 */
class SorghumSpline {
 public:
  std::vector<SorghumSplineSegment> segments;  ///< List of segments forming the spline.
