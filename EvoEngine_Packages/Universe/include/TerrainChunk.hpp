...
class TerrainChunk {
 ...
 public:
  ...
  TerrainChunk(const std::shared_ptr<PlanetTerrain>& planet_terrain, const std::shared_ptr<TerrainChunk>& parent,
               unsigned detail_level, glm::ivec2 chunk_coordinate, ChunkDirection direction, glm::dvec3 local_up);
