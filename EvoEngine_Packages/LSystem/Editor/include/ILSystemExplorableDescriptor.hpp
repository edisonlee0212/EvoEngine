...
// ----------------------------
// Lightweight abstract interface that any L-System editor adapter implements
...
//   1. create an editor adapter inheriting ILSystemExplorableDescriptor;
//   2. override RegisterExplorableAxes to list every field you want exposed;
//   3. own a `ParamSpaceExplorer explorer_` member in the editor adapter;
