...
OUTPUT_CSV = 'hourly_PAR_7leaf_plant_maricopa_june12.csv'
...
print("="*80)
print("SORGHUM 7-LEAF PLANT DAILY PAR CALCULATION - June 12, 2024")
print("="*80)
...
print(f"Plant: 7-leaf sorghum (7leaf-target.sg)")
print("="*80)
print()
