...
bool LogGrader::OnInspect(const std::shared_ptr<EditorLayer>& editor_layer) {
  ...
  if (debug_visualization) {
    ...
    // gizmoSettings);
    if (m_surface1)
      editor_layer->DrawGizmoMeshInstancedColored(Resources::Primitives::quad, m_surface1, transform.value, 1,
                                                  gizmo_settings);
    ...
    // gizmoSettings);
    if (m_surface2)
      editor_layer->DrawGizmoMeshInstancedColored(Resources::Primitives::quad, m_surface2, transform.value, 1.f,
                                                  gizmo_settings);
    ...
    // gizmoSettings);
    if (m_surface3)
      editor_layer->DrawGizmoMeshInstancedColored(Resources::Primitives::quad, m_surface3, transform.value, 1.f,
                                                  gizmo_settings);
    ...
    // gizmoSettings);
    if (m_surface4)
      editor_layer->DrawGizmoMeshInstancedColored(Resources::Primitives::quad, m_surface4, transform.value, 1.f,
                                                  gizmo_settings);
  }
