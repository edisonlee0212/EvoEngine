...
class HeightField : public IAsset {
 public:
  ...
  procedural_noise::ProceduralNoise2D noises_graph{};
   ...
   * @param unit_size The size of each unit in the grid.
   ...
   * @param x_depth The depth scaling factor in the X direction (default: 1.0f).
   * @param z_depth The depth scaling factor in the Z direction (default: 1.0f).
   */
  void GenerateMesh(const glm::vec2& start, const glm::uvec2& resolution, float unit_size,
