...
PrivateComponentRegistration<DsIntersectionBoundaryMesh> ds_intersection_boundary_mesh_registry(
    "DsIntersectionBoundaryMesh");
PrivateComponentRegistration<DsIntersectionBoundaryMeshGroup> ds_intersection_boundary_mesh_group_registry(
    "DsIntersectionBoundaryMeshGroup");
