...
bool DynamicStrandsDemo::OnInspect(const std::shared_ptr<EditorLayer>& editor_layer) {
  ...
  if (ImGui::Button("Fungus [Debris]")) {
    ...
    physics_parameters.ylw = 10.0f;
    physics_parameters.bb = 0.0f;
    physics_parameters.bw = 0.0f;
    physics_parameters.pc = 0.05f;

    physics_parameters.aw = 10.0f;
    physics_parameters.pl = 0.0f;

    physics_parameters.HL_threshold = 0.8f;
    physics_parameters.HC_threshold = 0.4f;
    ...
    physics_parameters.matrixAb = glm::mat3(80.f, 0.0f, 0.0f, 0.0f, 0.001f, 0.0f, 0.0f, 0.0f, 5.0f);  //(R,T,L)
