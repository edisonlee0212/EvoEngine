...
void DynamicStrands::BuildBranchesRenderingPipelines() {
  ...
  branches_point_light_render_pipeline->descriptor_set_layouts.emplace_back(strands_layout);
  ...
  branches_spot_light_render_pipeline->descriptor_set_layouts.emplace_back(strands_layout);
  ...
  branches_directional_light_render_pipeline->descriptor_set_layouts.emplace_back(strands_layout);
...
uint32_t DynamicStrands::RenderBranchesToPointLightShadowMap(const BranchesRenderParameters& render_parameters,
...
uint32_t DynamicStrands::RenderBranchesToSpotLightShadowMap(const BranchesRenderParameters& render_parameters,
                                                            const VkCommandBuffer vk_command_buffer,
...
uint32_t DynamicStrands::RenderBranchesToDirectionalLightShadowMap(
...
uint32_t DynamicStrands::RenderBranchesToCameraDeferred(
  ...
  branches_render_pipeline->BindDescriptorSet(vk_command_buffer, 0,
                                              RenderLayer::GetPerFrameDescriptorSet()->GetVkDescriptorSet());
  branches_render_pipeline->BindDescriptorSet(vk_command_buffer, 1,
