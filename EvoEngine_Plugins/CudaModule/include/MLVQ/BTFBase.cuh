...
#pragma region CUDA
  __device__ void GetValueDeg(const glm::vec2 &texCoord, const float &illuminationTheta, const float &illuminationPhi,
    ...
    m_pdf6.GetValDeg2(texCoord * m_texCoordMultiplier, illuminationTheta, illuminationPhi, viewTheta, viewPhi, out, tc,
                      print);
    if (print)
