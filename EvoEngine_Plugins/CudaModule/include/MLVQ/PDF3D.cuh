...
#pragma region CUDA
  ...
  __device__ void GetVal(const int &pdf3DIndex, T &out, SharedCoordinates &tc, const bool &print) const {
    ...
    m_pdf2.GetVal(m_devicePdf3DSlices[pdf3DIndex * m_numOfTheta + i + 1], out2, tc, print);
