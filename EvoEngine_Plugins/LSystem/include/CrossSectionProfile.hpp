...
class CrossSectionProfile {
 public:
  ...
  virtual void Sample(int sample_count, float radius,
                      std::vector<CrossSectionSample>& out_samples) const = 0;
  ...
  virtual void SampleWithAxes(int sample_count,
...
class CircularProfile final : public CrossSectionProfile {
 public:
  ...
  void Sample(int sample_count, float radius,
...
class SemiCircularProfile final : public CrossSectionProfile {
 public:
  explicit SemiCircularProfile(float adaxial_offset = 0.0f, int n_flat_samples = 2)
      : adaxial_offset_(adaxial_offset),
        n_flat_samples_(std::max(2, n_flat_samples)) {}
...
class EllipticProfile final : public CrossSectionProfile {
 public:
  ...
  void SampleWithAxes(int sample_count,
                      float primary_radius,
                      float secondary_radius,
                      std::vector<CrossSectionSample>& out_samples) const override {
    out_samples.clear();
