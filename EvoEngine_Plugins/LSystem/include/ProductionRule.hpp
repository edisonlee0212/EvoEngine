...
struct ProductionResult {
  ...
  [[nodiscard]] bool IsDeath() const { return successors.empty(); }
  [[nodiscard]] bool IsIdentity() const { return successors.size() == 1 && !successors[0].is_branch; }
  [[nodiscard]] bool IsExtension() const { return successors.size() > 1; }
};
