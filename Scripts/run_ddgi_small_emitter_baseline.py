...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--uniform-rays", type=int, default=128, help="Uniform/fixed rays per probe.")
    parser.add_argument("--guided-rays", type=int, default=0, help="Additive guided irradiance rays per probe.")
